...
public class store extends javax.swing.JFrame {
 ...
 public void tabledata(){
     int r=Table1.getSelectedRow();
        ...
        String count=Table1.getValueAt(r, 3).toString();
 ...
 public void serch(){
        ...
        try {
            ...
            String sql="SELECT * FROM store WHERE name LIKE '%"+serch+"%' OR brand LIKE '%"+serch+"%' OR count LIKE '%"+serch+"%' OR id LIKE '%"+serch+"%' OR price LIKE '%"+serch+"%'  ";
            pat=conn.prepareStatement(sql);
            rs=pat.executeQuery();
            Table1.setModel(DbUtils.resultSetToTableModel(rs));
  ...
  public void update(){
        ...
        try {
            ...
            String sql="UPDATE customer SET name='"+name+"' ,address='"+brand+"',tele='"+count+"',email='"+price+"' WHERE id='"+id+"'";
            pat=conn.prepareStatement(sql);
            pat.execute();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(42, 42, 42)
                .addComponent(sbox, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(sbox, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(24, 24, 24))
        );
